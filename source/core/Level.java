...
public class Level {
     ...
     */
    public Level(ArrayList<Tile> fixed, int width, int height, ArrayList<Tile> movables,
            Coordinate p1Pos, Coordinate p2Pos, Coordinate p3Pos, Coordinate p4Pos) {
        this.width = width;
        this.height = height;
    ...
    /**
     * Reads file and determines start location for all players Then sets each player's start
     *
    ...
    private void setStartCoordinates(Scanner in) {
        ...
        for (int i = 1; i <= MAX_PLAYERS; i++) {
            ...
            String[] coordinateArray = cLine.split(",");
            Coordinate playCoordinate = new Coordinate(Integer.parseInt(coordinateArray[1]),
                    Integer.parseInt(coordinateArray[2]));
            System.out.println(i);
            setPlayerPosition(playCoordinate, i);
        }
    }
    ...
    /**
     * Takes in a string value of tile type and outputs object
     *
