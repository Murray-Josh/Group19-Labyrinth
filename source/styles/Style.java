...
public abstract class Style implements Serializable {
     ...
     */
    protected Style(Image PLAYER_ONE, Image PLAYER_TWO, Image PLAYER_THREE, Image PLAYER_FOUR,
            Image STRAIGHT_TILE,
            Image STRAIGHT_FIRE, Image STRAIGHT_ICE, Image CORNER_TILE, Image CORNER_FIRE,
            Image CORNER_ICE,
            Image JUNCTION_TILE, Image JUNCTION_FIRE, Image JUNCTION_ICE, Image GOAL_TILE,
            Image GAMEBOARD) {
        ...
        switch (playerNumber) {
            ...
            default:
                throw new IndexOutOfBoundsException(
                        "<" + playerNumber + "> is not a valid player number");
        }
    }
