...
public class SilkBag implements Serializable {
    ...
    //    private final double FLOOR_TILES = floorSize(Gameboard.getSize()); // Currently cannot get floor tiles, static issue
    //placeholder below
    ...
    public void generate() {
        ...
        Effect[] effectArray = new Effect[]{new Fire(), new Ice(), new DoubleMove(), new Backtrack()};
