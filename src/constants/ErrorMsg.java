...
/**
 * Enum defining all the error messages and headers that will be displayed
 * through GUI
 *
 * @author Joseph Omar
 * @version 1.9
...
public enum ErrorMsg {
    FXML_NOT_FOUND(
            ...
            "FXML Not Found"),
    MESSGAGE_FAIL("The Message of the Day could not be fetched",
                  "Message of the Day Error"),
    PROFILE_ADD_ERROR(
            "That nickname is already taken, please choose a new one\n",
            "Cannot Create Profile"),
    PROFILE_FILE_NOT_FOUND(
            "The profiles save file <profiles.ser> could not be found" +
            ".\nPlease verify that the file is" +
            " in the saves folder.\n", "Profiles Not Found"),
    PROFILE_LOAD_ERROR(
            "The profiles save file <profiles.ser> could not be parsed\n",
            "Profile Parse Error"),
    PROFILE_NOT_SELECTED("You need to select at least two profiles",
                         "Not Enough Profiles Selected"),
