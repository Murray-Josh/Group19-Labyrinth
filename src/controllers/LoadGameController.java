...
public class LoadGameController implements Initializable {
    ...
    /**
     * Sets the collection of items that is shown on the listbox to the list
     * generated by getSaves()
     */
    ...
    /**
     * Finds all the files in the save folder that have the extension .labyrinth
    ...
    /**
     * Handles the event that occurs when load game is clicked. It checks if an
     * item is selected and if it is, sends the selected save file to the Logic
     * class
     *
     * @param actionEvent
     */
