...
public class Gameboard implements Serializable {
    ...
    /**
     * Creates a {@link Gameboard} from a Level Path, Style and a {@link java.util.Collection} of
     * {@link PlayerProfile}
     *
     ...
     * @throws IndexOutOfBoundsException If a tiles coordinate doesn't exist in the {@link
     *                                   Gameboard} {@link Matrix}
     * @throws NullPointerException      If there aren't enough tiles to be placed on the gameboard
     */
    public Gameboard(LevelType levelType, Level level, Style style,
     ...
     */
    private ArrayList<Holdable> combine(ArrayList<? extends Holdable> listA,
            ArrayList<? extends Holdable> listB) {
                ...
                if (tiles.get(i, j) == null) {
                    ...
                    if (temp != null) {
                        ...
                        throw new NullPointerException(
                                "Not enough movable tiles to create a gameboard");
                    }
                }
            }
        }
    ...
    /**
     * Creates a silk bag object from the leftover tiles and the action tiles from the level
     *
