...
public final class PirateStyle extends Style implements Serializable {
    static {
        ...
        STRAIGHT_ICE = new Image("pirate_straight_ice.png");
        CORNER_TILE = new Image("pirate_corner.png");
        CORNER_FIRE = new Image("pirate_fire.png");
        CORNER_ICE = new Image("pirate_corner_ice.png");
        JUNCTION_TILE = new Image("pirate_junction.png");
        JUNCTION_FIRE = new Image("pirate_fire.png");
        JUNCTION_ICE = new Image("pirate_junction_ice.png");
        GAMEBOARD = new Image("pirate_boarder.png ");
    }
    public PirateStyle() {
