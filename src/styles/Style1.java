 ...
 * @version 3.0
 */
public abstract class Style1 implements Serializable {
     ...
     */
    protected Style1(Image PLAYER_ONE, Image PLAYER_TWO, Image PLAYER_THREE, Image PLAYER_FOUR, Image STRAIGHT_TILE,
        ...
        Style1.PLAYER_ONE = PLAYER_ONE;
        Style1.PLAYER_TWO = PLAYER_TWO;
        Style1.PLAYER_THREE = PLAYER_THREE;
        Style1.PLAYER_FOUR = PLAYER_FOUR;
        Style1.STRAIGHT_TILE = STRAIGHT_TILE;
        Style1.STRAIGHT_FIRE = STRAIGHT_FIRE;
        Style1.STRAIGHT_ICE = STRAIGHT_ICE;
        Style1.CORNER_TILE = CORNER_TILE;
        Style1.CORNER_FIRE = CORNER_FIRE;
        Style1.CORNER_ICE = CORNER_ICE;
        Style1.JUNCTION_TILE = JUNCTION_TILE;
        Style1.JUNCTION_FIRE = JUNCTION_FIRE;
        Style1.JUNCTION_ICE = JUNCTION_ICE;
        Style1.GOAL_TILE = GOAL_TILE;
        Style1.GAMEBOARD = GAMEBOARD;
    }
